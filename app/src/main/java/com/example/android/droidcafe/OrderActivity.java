...
public class OrderActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void onSubmit(View view){
        String checkBoxOn ="Toppings: ";

        if(((CheckBox)findViewById(R.id.chocolate_syrup)).isChecked()){
            checkBoxOn+="Chocolate syrup ";
        }
        if(((CheckBox)findViewById(R.id.sprinkles)).isChecked()){
            checkBoxOn+="Sprinkles ";
        }
        if(((CheckBox)findViewById(R.id.crushed_nuts)).isChecked()){
            checkBoxOn+="Crushed nuts ";
        }
        if(((CheckBox)findViewById(R.id.cherries)).isChecked()){
            checkBoxOn+="Cherries ";
        }
        if(((CheckBox)findViewById(R.id.orio_cookie_crumbles)).isChecked()){
            checkBoxOn+="Orio cookie crumbles ";
        }
        displayToast(checkBoxOn);
    }
}
